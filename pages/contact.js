...
const Contact = () => {
    ...
    const submitForm = () => {
        emailjs
            .sendForm(
                'service_svcqm8b', 'template_15dycoc', form.current
            )
            .then(
                function (response) {
                    setSubmitted(true)
    ...
    return (
        <div className='flex items-center'>
            <Head>
                <title>Contact | Rizky Alfito Hadi</title>
            </Head>
            <div className='h-screen max-w-screen-xl px-4 py-16 mx-auto md:pt-32 md:p-20'>
                <div className='grid grid-cols-1 gap-x-16 gap-y-8 lg:grid-cols-5'>
                    <div className='lg:col-span-2'>
                        ...
                        Send me a message via email! <br />
                            <br />
                            ...
                            <a
                                className='text-blue-500 hover:underline'
                                href='https://www.instagram.com/ikyalfito/'
                                target='_blank'
                                rel='noopener noreferrer'
                            >
                                /ikyalfito/
                            ...
                            <div className='mt-4'>
                                {!submitted ? (
                                    ...
                                    >
                                        ...
                                        <Popup
                                            title='Message Sent! &#128077;'
                                            message='Terima kasih atas pesannya! Saya akan segera membalasnya'
                                            />
                                    ) : (
                                            <Popup
